...
from .my_functional import multi_head_attention_forward
...
class MultiheadAttention(Module):
    ...
    def forward(self, query: Tensor, key: Tensor, value: Tensor, key_padding_mask: Optional[Tensor] = None,
                ...
                average_attn_weights: bool = True, p_list=None) -> Tuple[Tensor, Optional[Tensor]]:
        r"""
    Args:
    ...
    Outputs:
        ...
        if not why_not_fast_path: # not in
            tensor_args = (
                query,
                key,
                value,
        ...
        if self.batch_first and is_batched: # not in
        ...
        if not self._qkv_same_embed_dim:
            ...
            attn_output, attn_output_weights = multi_head_attention_forward(
                ...
                training=self.training,
                key_padding_mask=key_padding_mask, need_weights=need_weights,
                attn_mask=attn_mask, average_attn_weights=average_attn_weights, p_list=p_list)
